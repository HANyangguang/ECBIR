...
newIndex = nmslib.init(method='hnsw', space=space_name,
...
def index():
    if request.method == 'POST':
        ...
        results = find_close_books(upload_dir + filename, resized_dir +
                                   filename, locations_agg, accumulated_indexes_boundaries, newIndex,)
