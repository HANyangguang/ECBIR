...
paths = [img_path for img_path in sorted(glob.glob('static/dataset/*/*.[Jj][Pp][Gg]'))]
...
accumulated_indexes_boundaries = list(accumulate([rea_dict[img][0].shape[0] for img in paths]))
...
pickle.dump(accumulated_indexes_boundaries, open('static/feature/accumulated_indexes_boundaries.pkl' ,'wb'))
