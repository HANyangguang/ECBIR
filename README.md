...
<p align="center"> 
   <img src="#" alt="Example Image" width="550" height="900">
</p>
...
[DELF Reference implementation](https://www.dlology.com/blog/easy-landmark-image-recognition-with-tensorflow-hub-delf-module/)
[Original implementation](https://github.com/lucko515/search-book-by-cover-server)
[HTML Structure](https://github.com/matsui528/sis)

### v1
then I improve its efficiency by removing the kd tree construction in the find_closest_book function. It reduces query time significantly by almost half of the former time spent.
